...
export default function Login() {
  ...
  const { signInWithEmail, login } = useAuth();
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 font-medium tracking-tight">Login to your MediCare account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          >
            {loading ? "Logging in..." : <><LogIn className="h-5 w-5" /> Sign In</>}
          </button>
        </form>
        ...
        <div className="mt-8">
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-xs uppercase font-bold tracking-widest bg-white px-4 text-gray-400">Or continue with</div>
          </div>
